    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap bg-white">
            <div class="px-20px mb-3">
                <input class="form-control bg-soft-primary border-0 form-control-sm text-black" type="text" name="" placeholder="{{ translate('Search in menu') }}" id="menu-search" onkeyup="menuSearch()">
            </div>
