@if (\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    ...
    @if(!empty($array))
        <section class="mb-4">
        <div class="container">
            <div style="font-family: 'RocknRoll One', sans-serif;" class="px-2 py-4 px-md-4 py-md-3   shadow-sm">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-success border-width-2 pb-3 d-inline-block">{{ translate('Best Sellers')}}</span>
                    </h3>
                    <a href="{{ route('sellers') }}" class="ml-auto mr-0 btn btn-danger btn-sm shadow-md">{{ translate('View All Sellers') }}</a>
                </div>
