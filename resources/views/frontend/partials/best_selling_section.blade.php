            ...
            <div style="font-family: 'RocknRoll One', sans-serif;" class="px-2 py-4 px-md-4 py-md-3  shadow-sm">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-success border-width-2 pb-3 d-inline-block">{{ translate('Best Selling') }}</span>
                    </h3>
                    <a href="javascript:void(0)" class="ml-auto mr-0 btn btn-success btn-sm shadow-md">{{ translate('Top 20') }}</a>
                </div>
