...
<section class="bg-primary py-2 border border-danger  text-light footer-widget">
    <div class="container">
        <div class="row">
                ...
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="77">
                        @else
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="77">
                        @endif
                    </a>
                    <div class="my-3 p-2">
                        @php
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled ">
                        <li class="mb-2">
                           <span class="d-block  text-dark">{{ translate('Address') }}:</span>
                           <span class="d-block opacity-100">{{ get_setting('contact_address') }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block  text-dark">{{translate('Phone')}}:</span>
                           <span class="d-block opacity-100">{{ get_setting('contact_phone') }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block  text-dark">{{translate('Email')}}:</span>
            ...
            <div class="col-md-4 col-lg-2">
                ...
                @if (get_setting('vendor_system_activation') == 1)
                    <div class="text-center text-md-left mt-4">
                        ...
                        <a href="{{ route('shops.create') }}" class="btn btn-dark btn-sm shadow-md">
                            {{ translate('Apply Now') }}
                        </a>
                    </div>
                @endif
