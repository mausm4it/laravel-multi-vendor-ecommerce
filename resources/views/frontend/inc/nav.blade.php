            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item mr-3">
                        <a href="{{ route('orders.track') }}" class="text-reset py-2 d-inline-block opacity-60">{{"Order Status"}}</a>
                    </li>
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-260 h-80px h-md-120px" height="120">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-260 h-80px h-md-120px" height="120">
                        @endif
                    </a>
                        ...
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="input-group">
                                    <input type="text" class="border-2 border-lg form-control" id="search" name="q" placeholder="{{translate('Search Anything...')}}" autocomplete="off">
                                    <div class="input-group-append d-none d-lg-block outline-primary">
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="border-top border-gray-200 py-1 bg-primary">
            <div class="container">
                <ul style="font-family: 'Akaya', cursive; font-size:20px;" class="list-inline mb-0 pl-0 mobile-hor-swipe text-right text-white">
                    @foreach (json_decode( get_setting('header_menu_labels'), true) as $key => $value)
                    <li class="list-inline-item mr-0">
                        <a href="{{ json_decode( get_setting('header_menu_links'), true)[$key] }}" class="opacity-5 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-white">
                            {{ translate($value) }}
                        </a>
                    </li>
                    @endforeach
